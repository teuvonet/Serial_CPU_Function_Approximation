...
__kernel void phase2_calculateradius(
                        ...
                        __global int *list_num_features_featurespaces, //list of features in features paces - [1,2,3]
                        __global int *cumulative_no_features_featurespace, //Cumulative sum of feature space - Easy for Indexing the base map - [1,3,6,10]
                        __global float *map, //Base Map of the Neurons
                        __global int *min_dist_pos, //Minimum distance array position
                        __global float *min_dist_array,//Minimum distance array
                        __global float *distance_map, //Distance Map of each neuro. calculated form each datapoint
                        __global float *radius_map, //Radius around teh Neuron
                        __global int *active_centers, //array to hold active centers count
                        __global float *Input_Data //Input Data Size
                    )
{
